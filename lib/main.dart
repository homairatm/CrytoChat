    ...
    if (currentUserNo == null || currentUserNo.isEmpty)
      unawaited(Navigator.pushReplacement(
          ...
          new MaterialPageRoute(
              builder: (context) =>
                  new LoginScreen(title: 'Sign in to CryptoChat By Homaira'))));
    else {
      setIsActive();
                                ...
                                return Theme(
                                  ...
                                  child: SimpleDialog(children: <Widget>[
                                    ListTile(
                                        ...
                                        subtitle: Padding(
                                            child: Text(
                                              'Enjoying using CryptoChat? Rate us!',
                                              textAlign: TextAlign.center,
                                            ),
                                            padding:
                                    ...
                                    Padding(
                                        child: Text(
                                          'Designed and developed by Homaira',
                                          style: TextStyle(
                                    ...
                                    Center(
                                        child: RaisedButton.icon(
                                            ...
                                            onPressed: () {
                                              launch(
                                                  'mailto:homairatm@gmail.com?subject=CrytoChat%20Feedback');
                                              Navigator.pop(context);
                                            }))
                                  ]),
                                );
